  ...
  export default {
    ...
    methods: {
      ...
      async onSaveClick() {
        ...
        const result = await doctorChatGroupRename({groupId: this.$attrs.groupId, groupName: this.groupName});
        if(result.success){
          this.$toast.success('修改成功');
          this.$emit('modifySuccess', this.groupName)
        }else{
