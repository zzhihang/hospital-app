<template>
    <div>
        ...
        <div class="bottom-button-box">
            ...
            <van-button type="primary" v-if="['YWC', 'YQX', 'BBH', 'YTK'].includes(orderInfo.orderStatus)"
                        @click="deleteClick">删除订单
            </van-button>
            <div v-if="['DZF'].includes(orderInfo.orderStatus)" style="display: flex;">
                <van-button type="primary" plain @click="cancelClick" class="mr10" style="width: 30%;flex-shrink: 0">
                    取消订单
                </van-button>
